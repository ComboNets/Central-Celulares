...
Generate the JSON source consumed by the live products API:
- `public/data/products.json`

The built `docs/data/products.json` file is only a static fallback generated by Vite builds. The deployed public site should read current products from `/api/products` on the admin Worker.
